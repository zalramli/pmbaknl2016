...
<!--  <img src="../images/aknl.png" alt=""/>-->
  ...
  echo '
    ...
    <p align="center" style="padding-top: -40px;font-size:15px;"><b>BUKTI PENDAFTARAN</b></p>
...
<table border='' style='margin-top: -70px;'>
	<tr>
		<td width="300px;" style="text-align: right;padding-left: 7px;"><div style="width: 90px;height: 100px;border: 1px solid black;"><p align="center"><br><br>4 X 6</p></div></td>
		<td width="100px;" style="padding-right: 20px;"></td>
		<td width="190px;">
			<?php
